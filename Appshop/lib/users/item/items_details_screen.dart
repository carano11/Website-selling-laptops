...
import 'package:appshop/users/controller/item_details_controller.dart';
...
{
  final Laptops? itemInfo;

  ItemDetailScreen({this.itemInfo,});
  ...
  addItemToCart() async
  {
    try
    {
      ...
      if(res.statusCode == 200) // connection with api to server - success
        ...
        {
          Fluttertoast.showToast(msg: "Error,Item not add to cart. Try again.");
        }
      }
      else
      {
    ...
    {
      print("Error addcart ::" + e.toString() );
    }
  }
              ...
              child: Row(
                children: [
                  ...
                  Obx(()=> IconButton(
                    onPressed: ()
                    {
                      if(itemDetailsController.favorite == true)
                      {
                    ...
                    icon: Icon(
                      itemDetailsController.favorite
                          ? Icons.bookmark
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: ()
                        {
                          ...
                          {
                            Fluttertoast.showToast(msg: "Số lượng sản phẩm không thể < 1");
                          }
                        },
                    ...
                    ()=> GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                            width: 2,
                            color: itemDetailsController.size == index ? Colors.transparent : Colors.grey,
                          ),
                          color: itemDetailsController.size == index ? Colors.purpleAccent.withOpacity(0.4)
                              : Colors.black,
                        ),
                ...
                return Obx(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(
                          width: 2,
                          color: itemDetailsController.color == index ? Colors.transparent : Colors.grey,
                        ),
                        color: itemDetailsController.color == index ? Colors.purpleAccent.withOpacity(0.4)
                            : Colors.black,
                      ),
                      alignment: Alignment.center,
                      child: Text(
